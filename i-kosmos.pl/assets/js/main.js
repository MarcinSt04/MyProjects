...
window.onbeforeunload = function () {
    ...
    function hideMobileMenu() {
        ...
        $(document).click(function() {
            if($('.link--on, #nav-links').hasClass('show') && $('#hamburger').hasClass('collapsed')==false) {
                $('#nav-links').removeClass('show');
                $('#hamburger').addClass('collapsed');
                $('#hamburger').attr('aria-expanded','false');
                $('#hamburger').removeClass('toggle');
    ...
    function fallingMoon() { //FUNKCJA SPADAJĄCEGO KSIĘŻYCA
        let moon = $('#big-moon');
    ...
    /*function scroll() {
        const scrollItems= document.querySelectorAll('.dropdown-item, .scroll-item');
        ...
        document.querySelector('.font-40').onclick=function(){
